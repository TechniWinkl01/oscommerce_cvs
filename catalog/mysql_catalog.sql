...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('General', 'FONT_STYLE_MAIN', '<font face="Verdana, Arial" size="2" color="black">', 'General font style', '5', '1', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Small Text', 'FONT_STYLE_SMALL_TEXT', '<font face="Verdana, Arial" size="1" color="black">', 'Small Text font style', '5', '2', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Navigation Bar', 'FONT_STYLE_HEADER_NAVIGATION_BAR', '<font face="Tahoma, Verdana, Arial" size="2" color="white">', 'Header Navigation Bar font style', '5', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Top Bar', 'FONT_STYLE_TOP_BAR', '<font face="Tahoma, Verdana, Arial" size="2" color="black">', 'Top Bar font style', '5', '4', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Heading', 'FONT_STYLE_HEADING', '<font face="Verdana, Arial" size="4" color="black">', 'Heading font style', '5', '5', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sub Bar', 'FONT_STYLE_SUB_BAR', '<font face="Verdana, Arial" size="1" color="black">', 'Sub Bar font style', '5', '6', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Table Heading', 'FONT_STYLE_TABLE_HEADING', '<font face="Verdana, Arial" size="2" color="black">', 'Table Heading font style', '5', '7', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Footer', 'FONT_STYLE_FOOTER', '<font face="Tahoma, Verdana, Arial" size="2" color="white">', 'Footer font style', '5', '8', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Account Categories', 'FONT_STYLE_ACCOUNT_CATEGORY', '<font face="Verdana, Arial" size="2" color="lightblue">', 'Account Category font style', '5', '13', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Field Entry', 'FONT_STYLE_FIELD_ENTRY', '<font face="Verdana, Arial" size="2" color="black">', 'Field Entry font style', '5', '14', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Field Value', 'FONT_STYLE_FIELD_VALUE', '<font face="Verdana, Arial" size="2" color="black">', 'Field Value font style', '5', '15', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('New Item In Cart', 'FONT_STYLE_NEW_CART_ITEM', '<font face="Verdana, Arial" size="1" color="red">', 'Font style for new items added to the cart', '5', '16', now());
