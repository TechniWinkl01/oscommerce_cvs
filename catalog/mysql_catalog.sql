...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Top Bar', 'FONT_STYLE_TOP_BAR', '<font face="Tahoma, Verdana, Arial" size="2" color="#000000">', 'Top Bar font style', '5', '2', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Heading', 'FONT_STYLE_HEADING', '<font face="Verdana, Arial" size="4" color="#000000">', 'Heading font style', '5', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sub Bar', 'FONT_STYLE_SUB_BAR', '<font face="Verdana, Arial" size="1" color="#000000">', 'Sub Bar font style', '5', '4', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Info-Box Headings', 'FONT_STYLE_INFO_BOX_HEADING', '<font face="Tahoma, Verdana, Arial" size="2">', 'Font style for info-box headings', '5', '5', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Info-Box Contents', 'FONT_STYLE_INFO_BOX_BODY', '<font face="Verdana, Arial" size="1">', 'Font style for info-box contents', '5', '6', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Listing Headings', 'FONT_STYLE_LIST_BOX_HEADING', '<font face="Verdana, Arial" size="2">', 'Font style for listing box headings', '5', '7', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Listing Contents', 'FONT_STYLE_LIST_BOX_BODY', '<font face="Verdana, Arial" size="1">', 'Font style for listing box contents', '5', '8', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('New Item In Cart', 'FONT_STYLE_NEW_CART_ITEM', '<font face="Verdana, Arial" size="1" color="#ff0000">', 'Font style for new items added to the cart', '5', '9', now());
