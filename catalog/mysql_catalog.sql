...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('New Item In Cart', 'FONT_STYLE_NEW_CART_ITEM', '<font face="Verdana, Arial" size="1" color="#ff0000">', 'Font style for new items added to the cart', '5', '6', now());
