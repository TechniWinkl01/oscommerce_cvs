<?php
/*
  $Id: specials.php,v 1.48 2003/06/05 23:33:40 hpdl Exp $
...
<?php
  ...
  $specials_split = new splitPageResults($specials_query_raw, $HTTP_GET_VARS['page'], MAX_DISPLAY_SPECIAL_PRODUCTS);
