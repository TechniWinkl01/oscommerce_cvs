<?php
/*
  $Id: specials.php,v 1.41 2002/06/16 20:58:31 harley_vb Exp $
...
*/
  ...
  $location = ' &raquo; <a href="' . tep_href_link(FILENAME_SPECIALS, '', 'NONSSL') . '" class="headerNavigation">' . NAVBAR_TITLE . '</a>';
?>
