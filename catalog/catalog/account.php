...
?>
      ...
      <tr>
        <td align="right" class="main"><br><a href="<? echo tep_href_link(FILENAME_ACCOUNT_EDIT, '', 'NONSSL'); ?>"><? echo tep_image_button('button_edit_account.gif', IMAGE_EDIT_ACCOUNT); ?></a>&nbsp;&nbsp;<a href="<? echo tep_href_link(FILENAME_ADDRESS_BOOK, '', 'NONSSL'); ?>"><? echo tep_image_button('button_address_book.gif', IMAGE_ADDRESS_BOOK); ?></a>&nbsp;&nbsp;<a href="<? echo tep_href_link(FILENAME_ACCOUNT_HISTORY, '', 'NONSSL'); ?>"><? echo tep_image_button('button_history.gif', IMAGE_HISTORY); ?></a>&nbsp;&nbsp;</td>
      </tr>
    </table></td>
<!-- body_text_eof //-->
    <td width="<? echo BOX_WIDTH; ?>" valign="top"><table border="0" width="<? echo BOX_WIDTH; ?>" cellspacing="0" cellpadding="0">
