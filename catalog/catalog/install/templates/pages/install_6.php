...
<table width="95%" border="0" cellpadding="2" class="formPage">
  <tr>
    ...
    <td width="70%" class="smallDesc">
      <?php echo tep_draw_input_field('DB_SERVER', (isset($_POST['DB_SERVER']) ? $_POST['DB_SERVER'] : '')); ?>
  ...
  <tr>
    ...
    <td width="70%" class="smallDesc">
      <?php echo tep_draw_input_field('DB_SERVER_USERNAME', (isset($_POST['DB_SERVER_USERNAME']) ? $_POST['DB_SERVER_USERNAME'] : '')); ?>
  ...
  <tr>
    ...
    <td width="70%" class="smallDesc">
      <?php echo tep_draw_password_field('DB_SERVER_PASSWORD', (isset($_POST['DB_SERVER_PASSWORD']) ? $_POST['DB_SERVER_PASSWORD'] : '')); ?>
  ...
  <tr>
    ...
    <td width="70%" class="smallDesc">
      <?php echo tep_draw_input_field('DB_TABLE_PREFIX', (isset($_POST['DB_TABLE_PREFIX']) ? $_POST['DB_TABLE_PREFIX'] : 'osc_')); ?>
  ...
  <tr>
    ...
    <td width="70%" class="smallDesc">
      <?php echo tep_draw_checkbox_field('USE_PCONNECT', 'true', (isset($_POST['USE_PCONNECT']) && $_POST['USE_PCONNECT'] == 'true' ? true : false)); ?>
  ...
  <tr>
    ...
    <td width="70%" class="smallDesc">
      <?php echo tep_draw_radio_field('STORE_SESSIONS', 'files', (!isset($_POST['STORE_SESSIONS']) || (isset($_POST['STORE_SESSIONS']) && $_POST['STORE_SESSIONS'] == 'files') ? true : false)); ?>&nbsp;<?php echo CONFIG_SESSION_STORAGE_FILES; ?>&nbsp;&nbsp;<?php echo tep_draw_radio_field('STORE_SESSIONS', 'mysql', (isset($_POST['STORE_SESSIONS']) && $_POST['STORE_SESSIONS'] == 'mysql' ? true : false)); ?>&nbsp;<?php echo CONFIG_SESSION_STORAGE_DATABASE; ?>&nbsp;&nbsp;
