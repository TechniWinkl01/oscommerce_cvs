<?php
/*
  $Id: upgrade_3.php,v 1.66 2004/02/16 06:59:43 hpdl Exp $
...
<?php
  ...
  $osC_Database->simpleQuery("insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Log Date Format', 'STORE_PARSE_DATE_TIME_FORMAT', '%d/%m/%Y %H:%M:%S', 'The date format', '10', '3', now())");
  ...
  $osC_Database->simpleQuery("insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Compression Level', 'GZIP_LEVEL', '5', 'Use this compression level 0-9 (0 = minimum, 9 = maximum).', '14', '2', now())");
  ...
  $osC_Database->simpleQuery("insert into configuration_group values ('10', 'Logging', 'Logging configuration options', '10', '1')");
  ...
  $osC_Database->simpleQuery("insert into configuration_group values ('14', 'GZip Compression', 'GZip compression options', '14', '1')");
  $osC_Database->simpleQuery("insert into configuration_group values ('15', 'Sessions', 'Session options', '15', '1')");
