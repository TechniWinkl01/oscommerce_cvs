# $Id: oscommerce.sql,v 1.42 2002/05/13 13:29:13 dgw_ Exp $
#
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Tax Class','MODULE_ORDER_TOTAL_SHIPPING_TAX_CLASS','1','Use the following tax class on the shipping fee.','6','6',now(),'tep_get_tax_class_title','tep_cfg_pull_down_tax_classes(');
