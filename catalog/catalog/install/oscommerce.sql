# $Id: oscommerce.sql,v 1.14 2002/01/28 05:16:46 hpdl Exp $
#
...
CREATE TABLE orders_status (
   orders_status_id int(5) NOT NULL auto_increment,
   language_id int(5) DEFAULT '1' NOT NULL,
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Send out Emails', 'SEND_EMAILS', 'true', 'Send out Emails', '1', '13', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Verfiy Email Addresses Through DNS', 'ENTRY_EMAIL_ADDRESS_CHECK', 'false', 'Verfiy Email address through a DNS server', '1', '16', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
