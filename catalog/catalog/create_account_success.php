...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <td><div align="center"><font face="<?=HEADING_FONT_FACE;?>" size="<?=HEADING_FONT_SIZE;?>" color="<?=HEADING_FONT_COLOR;?>"><?=HEADING_TITLE;?>&nbsp;</font></div><br><font face="<?=TEXT_FONT_FACE;?>" size="<?=TEXT_FONT_SIZE;?>" color="<?=TEXT_FONT_COLOR;?>"><?=TEXT_ACCOUNT_CREATED;?></font></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="right" nowrap><br><a href="<?=tep_href_link(FILENAME_DEFAULT, '', 'NONSSL');?>"><?=tep_image(DIR_IMAGES . 'button_lets_shop.gif', '104', '24', '0', IMAGE_LETS_SHOP);?></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
      </tr>
    </table></td>
<!-- body_text_eof //-->
    <td width="<?=BOX_WIDTH;?>" valign="top"><table border="0" width="<?=BOX_WIDTH;?>" cellspacing="0" cellpadding="0">
