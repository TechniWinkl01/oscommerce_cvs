<?php
/*
  $Id: tell_a_friend.php,v 1.27 2002/07/21 23:38:58 hpdl Exp $
...
*/
  ...
  $breadcrumb->add(NAVBAR_TITLE, tep_href_link(FILENAME_TELL_A_FRIEND, 'send_to=' . $HTTP_GET_VARS['send_to'] . '&products_id=' . $HTTP_GET_VARS['products_id'], 'NONSSL'));
