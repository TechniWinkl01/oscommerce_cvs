<?php
/*
  $Id: products_new.php,v 1.15 2002/01/09 17:19:25 hpdl Exp $
...
*/
  ...
  $location = ' : <a href="' . tep_href_link(FILENAME_PRODUCTS_NEW, '', 'NONSSL') . '" class="headerNavigation">' . NAVBAR_TITLE . '</a>';
?>
