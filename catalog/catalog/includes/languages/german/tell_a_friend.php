<?php
/*
  $Id: tell_a_friend.php,v 1.6 2001/12/20 14:14:15 dgw_ Exp $
...
define('TEXT_EMAIL_SUBJECT', 'Ihr Freund %s, hat diesen tollen Artikel gefunden, und zwar hier: %s');
define('TEXT_EMAIL_INTRO', 'Hallo %s!' . "\n\n" . 'Ihr Freund, %s, hat diesen tollen Artikel %s bei %s gefunden.');
