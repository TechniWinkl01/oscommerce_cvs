<?php
/*
  $Id: cookie_usage.php,v 1.3 2003/07/08 16:45:36 dgw_ Exp $
...
define('TEXT_INFORMATION', 'Hemos detectado que su navegador no soporta cookies o los tiene desactivados.<br><br>Para continuar comprando, le invitamos a activar los cookies en su navegador.<br><br>Para el navegador <b>Internet Explorer</b>, siga estas instrucciones:<br><ol><li>En el men&uacute; de Herramientas seleccione Opciones de Internet</li><li>Seleccione la pesta&ntilde;a de Seguridad y establezca el nivel de seguridad en la posicion Media</li></ol>Hemos adoptado esta medida de seguridad en su beneficio y le pedimos disculpas anticipadas por cualquier inconveniente que pudiera ocasionarle.<br><br>Pongase en contacto con nosotros con cualquier pregunta que tenga al respecto o para realizar sus compras offline.');
