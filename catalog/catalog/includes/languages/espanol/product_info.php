...
define('TEXT_MORE_INFORMATION', 'Para obtener mas informacion, visite la <a href="http://%s" target="blank"><u>pagina</u></a> del producto.');
define('TEXT_DATE_ADDED', 'Este producto esta en nuestro catalogo desde %s.');
define('TEXT_ALSO_PURCHASED_PRODUCTS', 'Cliente que compraron este producto, tambien han comprado');
