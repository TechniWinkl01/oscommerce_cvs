<?php
/*
  $Id: create_account_process.php,v 1.6 2001/06/10 15:38:39 mbs Exp $
...
define('EMAIL_GREET_MR', 'Estimado ' . $lastname . ',' . "\n\n");
define('EMAIL_GREET_MS', 'Estimado ' .$lastname . ',' . "\n\n");
define('EMAIL_GREET_NONE', 'Estimado ' . $lastname . ',' . "\n\n");
