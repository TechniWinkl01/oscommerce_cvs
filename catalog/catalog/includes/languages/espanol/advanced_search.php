...
define('ENTRY_KEYWORDS', 'Palabras Clave:');
define('ENTRY_PRICE_FROM', 'Desde precio:');
define('ENTRY_DATE_ADDED_FROM', 'De fecha de alta:');
define('ENTRY_TO', 'a:');
define('ENTRY_SORT_BY' , 'Resultado Ordenado Por:');
define('ENTRY_KEYWORDS_TEXT', '&nbsp;<small><font color="#AABBDD">(palabras o frases)</font></small>');
