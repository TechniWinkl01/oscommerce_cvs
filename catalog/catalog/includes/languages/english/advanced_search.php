...
define('ENTRY_KEYWORDS_TEXT', '&nbsp;<small><font color="#AABBDD">(one or more keywords separated with space)</font></small>');
...
define('JS_TO_DATE_LESS_THAN_FROM_DATE', '* To Date must be greater or equal to From Date\n');
define('JS_PRICE_FROM_MUST_BE_NUM', '* Price From must be a number\n');
define('JS_PRICE_TO_MUST_BE_NUM', '* Price To must be a number\n');
define('JS_PRICE_TO_LESS_THAN_PRICE_FROM', '* Price To must be greater or equal to Price From\n');
?>
