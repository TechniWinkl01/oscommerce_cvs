<?php
/*
  $Id: product_info.php,v 1.12 2001/06/13 12:15:01 mbs Exp $
...
define('TOP_BAR_TITLE', 'Product Information');
define('TEXT_PRODUCT_NOT_FOUND', 'Product not found!');
define('TEXT_CURRENT_REVIEWS', 'Current Reviews:');
define('TEXT_MORE_INFORMATION', 'For more information, please visit this products <a href="' . tep_href_link(FILENAME_REDIRECT, 'action=url&goto=%s') . '" target="blank"><u>webpage</u></a>.');
