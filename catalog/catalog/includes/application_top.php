<?php
/*
  $Id: application_top.php,v 1.107 2001/04/19 21:51:14 dwatkins Exp $
...
// define the filenames used in the project
  ...
  define('FILENAME_PRODUCT_LISTING', 'column_product_listing.php'); // 2 possible values: product_listing.php or column_product_listing)
