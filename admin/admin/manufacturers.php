...
<?
    $manufacturers = tep_db_query("select manufacturers_id, manufacturers_name, manufacturers_location, manufacturers_image from manufacturers order by $order_by");
    $rows = 0;
...
<?
        $ids[] = $manufacturers_values['manufacturers_id'];
        rsort($ids);
        $next_id = ($ids[0] + 1);
      }
    }
