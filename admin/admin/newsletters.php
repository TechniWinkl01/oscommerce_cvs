<?php
/*
  $Id: newsletters.php,v 1.1 2002/03/08 18:38:17 hpdl Exp $
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td class="tableHeading" align="right"><?php echo TABLE_HEADING_SENT; ?></td>
...
<?php
    $newsletters_query_raw = "select newsletters_id, title, length(content) as content_length, module, date_added, date_sent, status from " . TABLE_NEWSLETTERS . " order by date_added desc";
...
<?php
      if ($newsletters['status'] == '1') {
        echo tep_image(DIR_WS_IMAGES . 'icon_status_green.gif', 'Active', 10, 10) . '&nbsp;&nbsp;' . tep_image(DIR_WS_IMAGES . 'icon_status_red_light.gif', 'Inactive', 10, 10);
      } else {
        echo tep_image(DIR_WS_IMAGES . 'icon_status_green_light.gif', 'Active', 10, 10) . '&nbsp;&nbsp;' . tep_image(DIR_WS_IMAGES . 'icon_status_red.gif', 'Inactive', 10, 10);
      }
?></td>
