<?php
/*
  $Id: currencies.php,v 1.16 2001/09/19 10:14:23 mbs Exp $
        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="tableHeading">&nbsp;<?php echo TABLE_HEADING_CURRENCY_ID; ?>&nbsp;</td>
...
?>
                <td class="smallText">&nbsp;<?php echo $currencies['currencies_id']; ?>&nbsp;</td>
                <td class="smallText">&nbsp;<?php echo $currencies['title']; ?>&nbsp;</td>
