<?php
/*
  $Id: customers.php,v 1.48 2001/12/14 13:19:17 jan0815 Exp $
...
<?php
  if ($HTTP_GET_VARS['action'] == 'confirm') {
    ...
    $info_box_contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_ORDERS, 'action=search&customers_id=' . $cuInfo->id, 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . 'button_orders.gif', IMAGE_ORDERS) . '</a>&nbsp;<a href="' . tep_href_link('mail.php', 'selected_box=tools&customer=' . $cuInfo->email_address, 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . 'button_email.gif', IMAGE_EMAIL) . '</a><br>');
