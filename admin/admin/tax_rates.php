...
?>
                ...
                <td nowrap><font face="<? echo SMALL_TEXT_FONT_FACE; ?>" size="<? echo SMALL_TEXT_FONT_SIZE; ?>" color="<? echo SMALL_TEXT_FONT_COLOR; ?>">&nbsp;<? echo number_format($rates['tax_rate'], 2); ?>%&nbsp;</font></td>
<?
    if ($rates['tax_rates_id'] == @$trInfo->id) {
?>
