<?php
/*
  $Id: reviews.php,v 1.5 2001/09/19 11:12:00 mbs Exp $
...
define('TEXT_DELETE_REVIEW_INTRO', 'Are you sure you want to delete this review?');

define('TEXT_DATE_ADDED', 'Date Added:');
define('TEXT_LAST_MODIFIED', 'Last Modified:');
define('TEXT_IMAGE_NONEXISTENT', 'IMAGE DOES NOT EXIST');
define('TEXT_REVIEW_AUTHOR', 'Author:');
define('TEXT_REVIEW_RATING', 'Rating:');
define('TEXT_REVIEW_READ', 'Read:');
define('TEXT_REVIEW_SIZE', 'Size:');
