...
define('TEXT_INFO_COPY_TO_INTRO', 'Bitte w&auml;hlen Sie eine neue Kategorie in die sie den Artikel kopieren m&ouml;chten :');
...
define('TEXT_MOVE_NOTE', '<small><b>NOTE:</b></small> Nehmen Sie ein wenig Koffein bevor Sie irgendetwas verschieben!');

define('TEXT_NEW_CATEGORY_INTRO', 'Bitte f&uuml;llen Sie die folgenden Daten f&uuml;r die neue Kategorie:');
...
define('TEXT_PRODUCTS_MODEL', 'Artikel-Modell:');
