<?php
/*
  $Id: order.php,v 1.2 2002/04/08 01:55:34 hpdl Exp $
...
*/
  ...
  class order {
    ...
    function query($order_id) {
      ...
      $totals_query = tep_db_query("select title, text from " . TABLE_ORDERS_TOTAL . " where orders_id = '" . $order_id . "' order by sort_order");
