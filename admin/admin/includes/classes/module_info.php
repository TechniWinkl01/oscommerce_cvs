...
// class constructor
    function moduleInfo($mInfo_array) {
      ...
      for ($i=0; $i<sizeof($mInfo_array)-1; $i++) { // minus 1 due to 'code'
        $key_value_query = tep_db_query("select configuration_title, configuration_value, configuration_description from configuration where configuration_key = '" . $mInfo_array[$i] . "'");
